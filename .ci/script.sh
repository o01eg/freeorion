...
DIST=$1
DISTNAME=../freeorion_0.4.10.1+ppa${BUILD_PPA}~${DIST}
echo "Building package ${DISTNAME}..."
sed -i "1,+1{s/xenial\|bionic\|disco\|eoan\|focal\|groovy/${DIST}/g}" debian/changelog  || end_with_error "Cann't set distribution"
