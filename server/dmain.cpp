...
int wmain(int argc, wchar_t* argv[], wchar_t* envp[]) {
    ...
    try {
        ...
        db.Add<bool>("network.server.allow-email.new-turn",                 UserStringNop("OPTIONS_DB_ALLOW_EMAIL_NEW_TURN"),       true);
        ...
        db.Add<bool>("network.server.send-turn-chat",                       UserStringNop("OPTIONS_DB_SEND_TURN_CHAT"),             false);
#if defined(FREEORION_LINUX)
